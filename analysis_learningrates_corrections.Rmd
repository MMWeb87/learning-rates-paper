...
# first take the average to avoid any comma errors
...
for(type in types){
  ...
  for(i in 1:length(intervals)){
    ...
    l <- calculate_learning_rate(regression_costs, regression_cumulative_capacity)
    l_lin <- calculate_learning_rate(regression_costs, regression_cumulative_capacity, transformation = "none")
...
bind_rows(lr_result_1,lr_result_2) %>% 
  write_csv(paste0("output/results/learning_rate_results_",params$delta,"_",params$lead_currency,".csv"))
