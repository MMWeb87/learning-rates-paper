...
```{r Combined and normed plot, echo=FALSE, fig.asp=0.6, fig.cap="Comparison of learning rates, as index of the average costs in 2006", fig.width=fig.width.baseline * 0.8}
...
for(type in types){
  ...
  for(i in 1:length(intervals)){
    ...
    write_debug_information(l_lin$b1, paste0(debug_prefix, "coefficient_lin"))
...
bind_rows(lr_result_1,lr_result_2) %>% 
  write_csv(paste0("output/results/learning_rate_results_",params$capacity_data,"_",params$lead_currency,".csv"))
