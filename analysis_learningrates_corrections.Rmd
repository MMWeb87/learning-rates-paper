...
```{r plot, eval=FALSE, fig.asp=0.6, fig.cap="Comparison of all different exchange rates", fig.width=fig.width.baseline * 0.8, include=FALSE}
...
simple_learning_rates %>% 
  rownames_to_column(var = "currency") %>% 
