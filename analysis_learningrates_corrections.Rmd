...
# calculation of count based calculation
...
P[["uncorrected_project_weighted2"]] <- calculate_P(P_comp_pwt) #P_pw
P[["uncorrected_markted_weighted"]] <- calculate_P(P_comp) # P 
P[["corrected_markted_weighted"]] <- calculate_P(P_comp_tilde) # P_tilde  
...
types <- c(
  ...
  "uncorrected_markted_weighted",
  "corrected_markted_weighted")
...
results_new %>% 
  ...
  write_csv(paste0("output/results/test_learning_rate_results_",params$lead_currency,"_",version,".csv"))
