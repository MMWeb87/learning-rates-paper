...
factor_order_intervals = as.character(names(intervals))
  ...
  plots[[interval_name]] <- reduce(all_learnig_rates_results, bind_rows) %>% 
    ...
    mutate(
      ...
      interval = fct_recode(interval,
         "Full interval (2006-2016)" = "2006-2016",
         "Half interval (2006-2011)" = "2006-2011",
         "Half interval (2011-2016)" = "2011-2016")
      ) %>% 
